...
class MapFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val backButton = view.findViewById<ImageButton>(R.id.backButtonMap)

        val listButton = view.findViewById<ImageButton>(R.id.listButtonMap)
        ...
        listButton.setOnClickListener {
            ...
            listButton.setBackgroundColor(resources.getColor(R.color.gray))
            val handler = Handler()
            handler.postDelayed(Runnable {
                listButton.setBackgroundColor(resources.getColor(R.color.transparent))
            }, 50)
